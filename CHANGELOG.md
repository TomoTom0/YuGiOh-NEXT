...
### Changed
- デバッグログの削除によるブラウザコンソール改善
- 自動検索ロジックの並列実行化とスマート結果絞り込み
- ページネーション処理の共通化
- Products 表示のソート順をコード昇順に変更

### Fixed
- キーボードショートカット設定の復元不具合
- カード詳細表示関連の初期化処理

詳細: [v0.5.1 変更履歴](./docs/changelog/v0.5.1.md)
...
### Added
- デッキ表示ページにカード詳細表示機能を追加
- 複数のタブ構成（Search / Related / Products / Q&A）
- カード情報ボタン（i ボタン）の追加
- 他ユーザーのデッキ複製機能

### Changed
- CardDetailStore をデッキ編集ページと共有可能に

詳細: [v0.5.0 変更履歴](./docs/changelog/v0.5.0.md)
