...
#### UX
- 表示する画像の大きさ: s,m,l,xl
- 検索入力欄の位置: right top/right bottom/left bottom
- side,extraセクションの配置: 縦、横

- デッキ枚数制限: no limit/ current limit
- 未保存時の警告: alway/ without sorting order only/ never
- 右クリックでカード移動、中クリックでカード追加
