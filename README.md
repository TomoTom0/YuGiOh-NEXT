...
**現在のバージョン**: v0.4.4 ([変更履歴](./docs/changelog/))
...
**多言語対応**
- 公式サイトの10言語に対応（日本語/英語/韓国語/中国語/独仏伊西葡語）
...
**マウス操作** (v0.4.2)
- 右クリックでカード移動（Main → Extra等）
- 中クリックでカード追加（検索結果から直接）
